...
import (
	...
	bookscomv1 "github.com/RejwankabirHamim/crd/pkg/apis/books.com/v1"
	...
	v1 "github.com/RejwankabirHamim/crd/pkg/generated/listers/books.com/v1"
...
func (f *bookStoreInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&bookscomv1.BookStore{}, f.defaultInformer)
}
